package com.vslifb.showdomilhao.config;

import com.vslifb.showdomilhao.model.Role;
import com.vslifb.showdomilhao.model.User;
import com.vslifb.showdomilhao.repository.UserRepository;
...
public class MyUsernamePwdAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate( Authentication authentication ) throws AuthenticationException
    {
                ...
                passwordEncoder.matches( htmlFormPassword, fetchedUser.getPassword() ) ) // usando BcryptEncoder
        {
            ...
            return new UsernamePasswordAuthenticationToken(
                     ...
                     * passamos null.
                     */
                    fetchedUser.getName(), null, getGrantedAuthorities( fetchedUser.getUserFkRole() )
            );
        } else
        {
    ...
    private List<GrantedAuthority> getGrantedAuthorities(Role role) {
        ...
        // Certifique-se de que a String vinda do banco (ex: "ROLE_ADMIN")
        // seja passada exatamente assim para o SimpleGrantedAuthority
